...
/** Inscrições em memória — SÓ para dev sem banco e testes de rota. Expõe `rows` para
 * o dev de recebimentos espelhar a confirmação (IN-08). */
export function inMemoryBookings(): BookingRepository & { rows: BookingRecord[] } {
