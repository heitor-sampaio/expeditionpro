...
/** Fake in-memory do port da fila de identidade. Excluído do build (`*.fake.ts`). */
export function fakeIdentityChangeRepository(): IdentityChangeRepository & {
  rows: (IdentityChangeRequestRecord & { tenantId: string })[];
} {
